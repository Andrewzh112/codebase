...
parser.add_argument('--checkpoint_dir', type=str, default='dcgan/checkpoint', help='Path to where model weights will be saved')
parser.add_argument('--sample_dir', type=str, default='dcgan/samples', help='Path to where generated samples will be saved')
parser.add_argument('--log_dir', type=str, default='dcgan/logs', help='Path to where logs will be saved')
