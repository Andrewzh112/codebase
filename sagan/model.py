...
class Discriminator(nn.Module):
    def __init__(self, args):
        ...
        self.disc = nn.Sequential(
            ...
            SA_Conv2d(args.h_dim*2, k=1),
            ConvNormAct(args.h_dim*2, args.h_dim*4, 'down', activation='lrelu', normalization='bn'),
            *[ResBlock(args.h_dim*4, activation='lrelu', normalization='bn') for _ in range(args.n_res_blocks)],
...
class Generator(nn.Module):
    def __init__(self, args):
        ...
        self.gen = nn.Sequential(
            ...
            *[ResBlock(args.h_dim*4, activation='relu', normalization='bn') for _ in range(args.n_res_blocks)],
